        ...
        <div class="flex flex-col min-h-screen items-center justify-center p-6">
            ...
            <div class="w-full max-w-md bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                <div class="p-8">
                    ...
                    @if(session('error'))
                        <div class="bg-red-100 dark:bg-red-900 text-red-700 dark:text-red-300 p-3 rounded-lg mb-6">
                            {{ session('error') }}
                        </div>
                    @endif
                    ...
                    <div class="mt-6 text-center">
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            Belum punya akun? 
                            <a href="{{ route('custom.register') }}" class="text-blue-600 dark:text-blue-400 hover:underline font-medium">
                                Daftar sekarang
                            </a>
                        </p>
                    </div>
